...
namespace Aritter.Infra.Data.Migrations
{
    ...
    [Migration("20160804170008_20160804V1")]
    partial class _20160804V1
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Aritter.Domain.SecurityModule.Aggregates.Permissions.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Aritter.Domain.SecurityModule.Aggregates.Users.Profile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Aritter.Domain.SecurityModule.Aggregates.Users.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Aritter.Domain.SecurityModule.Aggregates.Permissions.Authorization", b =>
                {
                    ...
                    b.HasOne("Aritter.Domain.SecurityModule.Aggregates.Permissions.Role", "Role")
                        .WithMany("Authorizations")
            ...
            modelBuilder.Entity("Aritter.Domain.SecurityModule.Aggregates.Permissions.UserAssignment", b =>
                {
                    ...
                    b.HasOne("Aritter.Domain.SecurityModule.Aggregates.Users.User", "User")
                        .WithMany("UserAssignments")
            ...
            modelBuilder.Entity("Aritter.Domain.SecurityModule.Aggregates.Users.User", b =>
                {
                    b.HasOne("Aritter.Domain.SecurityModule.Aggregates.Users.Profile", "Profile")
                        .WithOne("User")
                        .HasForeignKey("Aritter.Domain.SecurityModule.Aggregates.Users.User", "ProfileId")
