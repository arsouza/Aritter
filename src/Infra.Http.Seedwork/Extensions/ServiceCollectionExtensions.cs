...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class ServiceCollectionExtensions
    {
        public static IServiceCollection AddValidatorFactory(this IServiceCollection services, IEntityValidatorFactory validatorFactory)
        {
            ...
            services.AddSingleton<IEntityValidator>(factory => factory.GetService<IEntityValidatorFactory>().Create());
            return services;
        }
        ...
        {
            services.AddValidatorFactory(new TEntityValidatorFactory());
            return services;
        }
    }
}
